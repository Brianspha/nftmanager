...
contract DodgeEMToken is IERC20, Initializable {
    ...
    function mintNewTokens(uint256 supply) onlyOwner public returns(bool) {
        require(supply > 0, "New token supply must be greater than 0");
        supply = supply.add(supply * (10) ** _decimals);
